...
static class DeploymentController
{
    ...
    public static void HandleDeploymentInput()
    {
        ...
        if (SwinGame.MouseClicked(MouseButton.LeftButton))
        {
            ...
            {
                _currentDirection = Direction.UpDown;//Changed made from LeftRight to UpDown
    ...
    private static void DoDeployClick()
    {
        ...
        //changed ((mouse.Y) / (UtilityFunctions.CELL_HEIGHT + UtilityFunctions.CELL_GAP))); to current state 
